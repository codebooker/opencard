...
const LAYOUT_THUMBS: Record<string, string> = {
  ...
  wave: `<svg viewBox="0 0 40 60"><path d="M0,0 H40 V26 C33,31 26,30 18,24 C10,18 4,19 0,23 Z" fill="currentColor"/><rect x="9" y="34" width="22" height="3" rx="1.5" fill="#cbd5e1"/><rect x="11" y="41" width="18" height="2" rx="1" fill="#e5e7eb"/><rect x="6" y="50" width="28" height="6" rx="3" fill="currentColor"/></svg>`,
